...
public class Demo implements Serializable{
    ...
    public void LogMessage(String messageText, boolean message, boolean warning, boolean error) throws Exception {
        ...
        connection = DriverManager.getConnection("jdbc:mysql://localhost/dblog?useSSL=false", connectionProps);
        ...
        if(logToDatabase) {
            stmt.executeUpdate("insert into Log_Values (MENSAJE,PRIORIDAD) VALUES ('" + message + "', " + String.valueOf(t) + ")");
